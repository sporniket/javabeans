...
import com.sporniket.libre.javabeans.generator.core.PropertyGeneratorTypeMap;
 ...
 * 
 */
public class TestPropertyGeneratorTypeMap extends TestPropertyGenerator
{
	/**
	 * Name of the result file for generating a named enum property.
	 */
	private static String FILE_NAME_TEMPLATE__MAP = "result_property_map_{0}_{1}.txt";
	 ...
	 * Generator to test.
	 */
	private PropertyGeneratorTypeMap myGenerator;
	...
	protected void setUp() throws Exception
	{
		...
		myGenerator = new PropertyGeneratorTypeMap();
	 ...
	 * @throws IOException
	 */
	public void testNotNullBasicMap() throws IOException
	{
		doTestMode("map:HashMap:String:String:notNull:0", "notNull", PropertyMode.BASIC);
	}
	 ...
	 * @throws IOException
	 */
	public void testIsolatedBasicMap() throws IOException
	{
		doTestMode("map:HashMap:String:String:isolated:10", "isolated", PropertyMode.BASIC);
	}
	 ...
	 * @throws IOException
	 */
	public void testNotNullBoundableMap() throws IOException
	{
		doTestMode("map:HashMap:String:String:notNull:0", "notNull", PropertyMode.BOUNDABLE);
	}
	 ...
	 * @throws IOException
	 */
	public void testIsolatedBoundableMap() throws IOException
	{
		doTestMode("map:HashMap:String:String:isolated:10", "isolated", PropertyMode.BOUNDABLE);
	}
	 ...
	 * @throws IOException
	 */
	public void testNotNullVetoableMap() throws IOException
	{
		doTestMode("map:HashMap:String:String:notNull:0", "notNull", PropertyMode.VETOABLE);
	}
	 ...
	 * @throws IOException
	 */
	public void testIsolatedVetoableMap() throws IOException
	{
		doTestMode("map:HashMap:String:String:isolated:10", "isolated", PropertyMode.VETOABLE);
	}

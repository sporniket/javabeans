 ...
 * 
 */
public class PropertyGeneratorTypeColl implements PropertyGenerator
{
	/**
	 ...
	 * </dl>
	 */
	private static String FILE_NAME_TEMPLATE__COLL = "template_property_coll_{0}_{1}.txt";
			...
			BeanSet set)
	{
		...
		PropertyTypeColl _propertyType = (PropertyTypeColl) propertyType;
